# Steps for adding **Intro Slider**

- Create React-native-project
- install `react-native-app-intro-slider` Library
- collect array of images
...
Install `npm install react-native-app-intro-slider` library [from here](https://www.npmjs.com/package/react-native-app-intro-slider)

```
npm install react-native-app-intro-slider
```

## Step 3 in your screen
